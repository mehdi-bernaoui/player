...
main_application: ThemedTk = ThemedTk(theme="breeze")
main_application.title('Mehdi Music Player')
main_application.geometry('600x600')


status_bar_label = ttk.Label(main_application, text='Bienvenue au Music Player', relief=GROOVE, borderwidth=2,
...
# On commence le codage des icons
...
music_player_icon = PhotoImage(file='icon/SC Media Player Resized.png')
...
# on demarre le codage des commandes
...
def previous_song():
    ...
    if playlist_var == True:
        try:
            ...
            messagebox.showerror('Fichier introuvable', 'Impossible de trouver le fichier à lire. Veuillez vérifier à nouveau')
...
def playlist():
    ...
    if playlist_var == False:
        ...
        playlist_box.insert(0, 'Veuillez sélectionner un fichier audio')
...
def playmusic():
    ...
    try:
        ...
        messagebox.showerror('Fichier introuvable', 'Impossible de trouver le fichier. Veuillez sélectionner un fichier musical à lire')
...
def stopmusic():
    ...
    if stop_var == False:
        ...
        messagebox.showerror('Fichier introuvable',
                             'Impossible de trouver le fichier. Veuillez sélectionner un fichier musical à lire')
...
def set_vol(val):
    global mute_var
    volume = float(val) / 100  # La méthode de volume ou d'échelle envoie automatiquement la valeur sous forme de chaîne
    if mute_var == False:
